...
### Util
* [Google Map View](https://github.com/apptreesoftware/flutter_google_map_view) - Displaying google map plugin by AppTree Software
* [QR Code Reader](https://github.com/villela/flutter_qrcode_reader) - QR Code reader plugin by Matheus Villela
* [Flutter Location](https://github.com/Lyokone/flutterlocation) - Handle location, handling callbacks to get continuous location by Lyokone
* [Curve header](https://github.com/FlutterRocks/movie-details-ui) - Movie details page by Iiro Krankka
* [Profile from API](https://github.com/CodemateLtd/FlutterMates) - How to load profiles from the randomuser.me API and a nice profile details page by Iiro Krankka
* [Example profile page](https://github.com/tomialagbe/flutter_ui_challenges/tree/master/profile) - Profile App Design made by Shahin Srowar
* [Login page sample](https://github.com/alessandroaime/Weather) - Weather app that shows a demo of login page
